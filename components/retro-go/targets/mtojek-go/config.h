...
// Target definition
#define RG_TARGET_NAME             "MTOJEK-GO"

// Storage
#define RG_STORAGE_DRIVER           1                   // 0 = Host, 1 = SDSPI, 2 = SDMMC, 3 = USB, 4 = Flash
#define RG_STORAGE_HOST             SPI3_HOST           // Used by SDSPI and SDMMC
#define RG_STORAGE_SPEED            SDMMC_FREQ_PROBING  // Used by SDSPI and SDMMC
...
// Input
#define RG_GAMEPAD_DRIVER           2   // 1 = ODROID-GO, 2 = Serial, 3 = I2C, 4 = AW9523, 5 = ESPLAY-S3, 6 = SDL2
#define RG_GAMEPAD_HAS_MENU_BTN     1
#define RG_GAMEPAD_HAS_OPTION_BTN   1
#define RG_GPIO_GAMEPAD_MENU         GPIO_NUM_5
#define RG_GPIO_GAMEPAD_OPTION       GPIO_NUM_4
...
#define RG_GPIO_SND_I2S_WS          GPIO_NUM_27
